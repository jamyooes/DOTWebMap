...
The first option is to toggle the points on (Blue check mark, user can see the points on the map) or off (Empty box, user can not see the points on the map). The rest of the options are politcal boundaries:
<ul>
